...
<li>Use any third party OPC-UA client and connect to the local server (opc.tcp://<?lsp=demo.ipaddr?>:4841); see the <a  target="_blank" href="https://realtimelogic.com/ba/opcua/thirdparty_clients.html">Third Party Clients Tutorial</a> for details</li>
</ol>
